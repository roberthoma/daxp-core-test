...
//            if (msg.containsField(CRMDaxpRegister.CUSTOMER_ID)) {
//                Long id = Long.valueOf(msg.getStrValue(CRMDaxpRegister.CUSTOMER_ID));
//
...
//            Long customerId = Long.parseLong(msg.getStrValue(CRMDaxpRegister.CUSTOMER_ID));
//
